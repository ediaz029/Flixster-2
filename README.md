...
- [x] **Choose any endpoint on The MovieDB API except `now_playing`**
  - Chosen Endpoint: `movie/changes`
  - Chosen Endpoint 2: `person/changes`
...
Challenges I faced include reducing the spacing between the movie and celebrity items in the recyclerview.
